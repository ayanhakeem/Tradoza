...
import {recentRow, newCommentsRow, generalRow, userLevel, chartLevel, tabs} from "../components/issues";
...
export default class Issues extends React.Component {
	...
	getRowStructure(){
		...
		switch(state.currentView){
			...
			case "issues with recent activity":
				return recentRow;

			case "issues with new comments":
	...
	render(){
		...
		return(
			<div className="document-div general-area" id="printarea">
				<TabDualActionHeader secondTitle="CAPAs" to="/issues/capas" title="Issues" options={userLevel} userLevel={userLevel[state.userLevel]} onChange={this.changeUserLevel} />
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pad0">
					<Charts 
						...
						firstTitle="State of issues"
						firstChart="stateOfChart"
						secondTitle="Unresolved issues"
